...
import com.example.sfcsapp.Callback.IBestDealCallbackListener;
import com.example.sfcsapp.Callback.IPopularCallbackListener;
...
public class HomeViewModel extends ViewModel implements IPopularCallbackListener, IBestDealCallbackListener {
    ...
    @Override
    public void onBestDealSuccess(List<BestDealModel> bestDealModels) {
